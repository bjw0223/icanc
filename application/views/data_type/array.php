       ...
       <ul>
           <li>선언방법</li>
		       <ul>
                   ...
                   <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\1.PNG" width=540px; height=310px; style="margin-bottom:10px"><br>
               </ul><br>
  	       ...
  	       <li id="list" class="blue">&lt;참고사항 – 차원&gt;</li>
		       <ul>
                   ...
                   <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\2.PNG" width=650px; height=590px><br>
                   <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\3.PNG" width=560px; height=310px; style="margin-bottom:10px"><br>
                   <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\4.PNG" width=650px; height=500px; style="margin-left:10px; margin-bottom:10px"><br>
		       </ul><br>
           ...
           <li>2차원 배열의 선언 방법</li>
               ...
               <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\5.PNG" width=530px; height=190px; style="margin-bottom:10px"><br><br>
           <li>2차원 배열의 초기화</li>
		       <ul>
                   ...
                   <li class="general_sub">문자 배열의 첫 번째 첨자는 행의 수(문자열의 개수), 열의 수를 뜻하는 두 번째 첨자는 가장 긴 문자열 + 1(Null 문자)로 정해준다.</li>
                       <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\6.PNG" width=350px; height=250px; style="margin-bottom:10px; margin-top:10px"><br><br>
                       <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\7.PNG" width=550px; height=200px; style="margin-top:10px"><br><br>
                       <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\8.PNG" width=620px; height=560px; style="margin-top:10px"><br><br>
                       <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\9.PNG" width=400px; height=230px; style="margin-top:10px"><br><br>
		       </ul>
           <li>2차원 배열의 주소를 받을 때 형식</li>
               <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\10.PNG" width=550px; height=320px; style="margin-top:10px"><br><br>
           <li>선언문에서 첨자를 둘러싼 대괄호의 수에 따라 차원이 부여된다.</li><br>
           <li>3차원까지 이름이 있다(열, 행, 면)</li><br>
	       <li>첨자가 매우 많이 존재해도 메모리상에 연속적인 기억공간이 할당되는 것은 항상 같다.</li>
           <img src="<?=base_url()?>asset\lib\img\tutorial\data_type\array\11.PNG" width=650px; height=350px; style="margin-top:10px"><br><br>
