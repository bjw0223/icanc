<div class="col-lg-9 tutorial_desc">
    <span class="general">    
       <ul>
           ...
           <img src="<?=base_url()?>asset\lib\img\tutorial\function\scanf\1.PNG" width=630px; height=555px;><br><br>
		   <li>변경자 - 형식변환문자와 같이 쓰여 추가 옵션을 지정할 수 있다.</li>
           <img src="<?=base_url()?>asset\lib\img\tutorial\function\scanf\2.PNG" width=630px; height=270px;><br><br>
           <li>res = scanf(“%d %d %d”, &amp;a, &amp;b, &amp;c);</li>
              ...
              <img src="<?=base_url()?>asset\lib\img\tutorial\function\scanf\3.PNG" width=300px; height=70px style="margin-left:25px; margin-top:10px"><br><br>
