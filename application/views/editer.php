...
<div id="C_editer" style="margin-top:50px;backgrouno-color:silver;">
    <div class="container" style="background-color:silver;">
        <div class="row">
            <div class="col-lg-3 col-sm-3" style="margin:0px;padding:0;">
                <div class="row well" style="padding:8px;margin:0px;">
                    <div class="col-lg-12 col-sm-12" style="background-color:white;min-height:450px;">
                    d
                    </div>
                </div>
            </div>
            <div class="col-lg-9 col-sm-9" style="padding:0px;">
                ...
                <div class="row well" style="padding:8px;margin:0px;">
                    <div class="col-lg-12 col-sm-12" style="background-color:white;min-height:350px;">
                        <form  action="<?=base_url();?>index.php/compiler/compile" method="post">
                            <textarea id="code" name="code" class="col-lg-12 col-sm-12" style="resize:none;height:300px;"></textarea>
