    ...
    <div class="bs-sidebar">
       <ul class="nav bs-sidenav"> 
            <li class="active">
                <a href="#">프로그램</a>
                <ul class="nav">
                    <li><a href="<?=base_url();?>index.php/tutorial/program">이해</a></li>
            ...
            <div id="collapse_2" class="accordion-body collapse">
                <div class="accordion-inner">
                    <ul class="nav nav-list">
                        <li class="inactive"><a class="contents_list" href="#" data-in="system/decimal">10진법</a></li>
                        <li class="inactive"><a class="contents_list" href="#" data-in="system/octal">8진법</a></li>
                        <li class="inactive"><a class="contents_list" href="#" data-in="system/binary">2진법</a></li>
                        <li class="inactive"><a class="contents_list" href="#" data-in="system/hexadecimal">16진법</a></li>
                    </ul>
                </div>
            </div>
        </div>
