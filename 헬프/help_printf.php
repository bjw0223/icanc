...
<body>
	...
	<img src="printf_1-1.PNG"; width="550"; Height="150"><br/>
	<ol>
	<li>Register Size 만큼 입출력(4Byte)</li>
	<li><a>short</a> 형이 <a>int</a> 형으로 확장 되어 들어감</li>
	</ol>
	<img src="printf_1-2.PNG"; width="520"; Height="300"; style="padding-left:10px"><br/><br/> 

	<img src="printf_2-1.PNG"; width="300"; Height="110"; style="padding-left:15px"> 
        참 조 : <a id="ref" href="실수url"; style="font-weight:bold">실 수</a><br/>				
	<img src="printf_2-2.PNG"; width="520"; Height="300"; style="padding-left:10px"><br/>	
	<img src="printf_2-3.PNG"; width="550"; Height="110"; style="padding-left:10px"><br/>
